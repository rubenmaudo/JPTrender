...
public class CameraOLD {
    ...
    //CAMERA CONSTRUCTOR
    public CameraOLD(Vec3 lookfrom, Vec3 lookat, Vec3 vup, double vfov, double aspect_ratio,
     ...
     */
    public static CameraOLD generateCamera(double aspect_ratio, int cameraID){
        ...
        switch(cameraID){
            case 1:
                ...
                camera = new CameraOLD(lookfrom, lookat, vup, 90, aspect_ratio, aperture, dist_to_focus);
                return camera;
            ...
            case 3:
                ...
                camera = new CameraOLD(lookfrom, lookat, vup, 20, aspect_ratio, aperture, dist_to_focus);
                return camera;
            ...
            case 4:
                ...
                camera = new CameraOLD(lookfrom, lookat, vup, 70, aspect_ratio, aperture, dist_to_focus);
                return camera;
            ...
            case 5:
                ...
                camera = new CameraOLD(lookfrom, lookat, vup, 40, aspect_ratio, aperture, dist_to_focus);
                return camera;
            ...
            case 7:
                ...
                camera = new CameraOLD(lookfrom, lookat, vup, 50, aspect_ratio, aperture, dist_to_focus);
                return camera;
